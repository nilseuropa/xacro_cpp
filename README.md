...
| Expression evaluation                     | `${•}`                                                                  | Python       | tinyexpr (+, -, *, /, indexing `${var[2]}`) | OK                                 |
| Access property values                    | `${param_name}`                                                         | ✅           | ✅                             | OK                                                                                 |
| Symbols and functions                     | –                                                                       | Python math (pi, sin, exp, fabs) | pi, add: sin, cos, exp, abs, fabs | CAS-536: Add symbols/functions to xacro_cpp (To Do) |
...
| Rospack commands                          | `$(•)`                                                                  | $(find pkg), $(cwd) | $(find pkg), `${find('pkg')}` | Add cwd support (CAS-537, To Do) |
| Escaping dollar sign                      | `$$`                                                                    | ✅           | ✅                             | OK                                                                                 |
| Property blocks                           | `xacro:insert_block`                                                    | ✅           | ✅                             | OK                                                                                 |
| Macros                                    | `<xacro:macro name='m' ...>`                                            | ✅           | ✅                             | OK                                                                                 |
| Call macros                               | `<xacro:m .../>` or `<m .../>`                                          | ✅           | ✅                             | OK                                                                                 |
| Call macros (xacro:call)                  | `<xacro:call macro="bar"/>`                                             | ✅           | ❌                             | CAS-538: Add call macros (To Do)                                                   |
| Xacro element                             | `<xacro:element xacro:name="${name}"/>`                                 | ✅           | ✅                             |                                                                                    |
| Xacro attribute                           | `<xacro:attribute name="${name}" value="${value}"/>`                    | ✅           | ❌                             | CAS-540: Add xacro attribute (To Do)                                               |
| Block parameters                          | `params=*block1`                                                        | ✅           | ✅                             | OK                                                                                 |
| Headless block parameters                 | `params=**block2`                                                       | ✅           | ❌                             | CAS-541: Add headless block params (To Do)                                         |
...
| Properties have scoped namespaces         | –                                                                       | ❌           | ❌                             | CAS-542: Add scoped namespaces (To Do)                                             |
| Property scope attribute                  | `scope="parent|global"`                                                 | ❌           | ❌                             | CAS-543: Add scope attribute (To Do)                                               |
| Property forwarding                       | `params="arg1:=^"` or `arg1:=^|42`                                      | ✅           | ❌                             | Skip                                                                               |
| Property removal                           | `<xacro:property name="p" remove="true"/>`                              | ✅           | ❌                             | Skip                                                                               |
| Include                                    | `<xacro:include filename="..."/>`                                       | ✅           | ✅                             | OK                                                                                 |
| Include with namespace                     | `<xacro:include filename="..." ns="A"/>`                                | ✅           | ?                              | Allows `<xacro:A.foo/>` or `${A.var}`                                              |
| Include optionally                         | `<xacro:include filename="..." optional="True"/>`                       | ✅           | ❌                             | Skip                                                                               |
| Load YAML                                  | `<xacro:property name="props" value="${load_yaml(file)}"/>`             | ✅           | ✅                             | OK                                                                                 |
| YAML capabilities                          | –                                                                       | Full         | Partial (top-level numeric scalars/lists only) | CAS-544: Add full YAML (To Do)       |
| Conditional blocks                         | `xacro:if`, `xacro:unless`                                              | ✅           | ✅                             | OK                                                                                 |
| Removal of comments                        | automatic                                                               | ✅           | ❌                             | CAS-545: Add comment removal (To Do)                                               |
