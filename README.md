...
| Symbols and functions                     | –                                                                       | Python math (pi, sin, exp, fabs) | pi, add: sin, cos, exp, abs, fabs | CAS-536: Add symbols/functions to xacro_cpp  |
| Rospack commands                          | `$(•)`                                                                  | $(find pkg), $(cwd) | $(find pkg), `${find('pkg')}` | CAS-537: Add cwd support (To Do) |
| Call macros (xacro:call)                  | `<xacro:call macro="bar"/>`                                             | ✅           | ❌                             | CAS-538: Add call macros                                                    |
| Headless block parameters                 | `params=**block2`                                                       | ✅           | ❌                             | CAS-541: Add headless block params                                          |
| Properties have scoped namespaces         | –                                                                       | ❌           | ❌                             | CAS-542: Add scoped namespaces                                              |
| Property scope attribute                  | `scope="parent/global"`                                                 | ❌           | ❌                             | CAS-543: Add scope attribute                                                |
| YAML capabilities                          | –                                                                       | Full         | Partial (top-level numeric scalars/lists only) | CAS-544: Add full YAML        |
...
| Default property semantics                 | `<xacro:property name="p" default="..."/>`                              | ✅           | ❌                             | CAS-578: Implement default property semantics matching in xacro_cpp                                                                                   |
